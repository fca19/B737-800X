...
-- function B738_gpu_switch_pos_CMDhandler(phase, duration)
	-- if phase == 0 then
		-- if B738DR_ground_power_switch_pos == 0 then
			-- B738DR_ground_power_switch_pos = 1
		-- elseif B738DR_ground_power_switch_pos == 1 then
...
-- AIR COND
	...
	if B738DR_capt_6_pack_pos == 1 then
...
---- MASTER CAUTION ----------------------------------------------------------------------
	...
	local master_caution_light = 0
		...
		or six_pack_air_cond_ann == 1 then
...
-- HYD PRESSURE
	...
	local hyd_press_a_trg = 0
		...
		or B738DR_hydro_pumps1_switch_position == 0 then
			hyd_press_a_trg = 1
		end
	...
	local hyd_press_b_trg = 0
		...
		or B738DR_hydro_pumps2_switch_position == 0 then
			hyd_press_b_trg = 1
		end
...
--	B738DR_window_heat_fail = window_heat_fail * brightness_level
	B738DR_window_heat_fail_rf = window_heat_fail * B738DR_window_heat_r_fwd_pos * brightness_level
	B738DR_window_heat_fail_rs = window_heat_fail * B738DR_window_heat_r_side_pos * brightness_level
	B738DR_window_heat_fail_lf = window_heat_fail * B738DR_window_heat_l_fwd_pos * brightness_level
	B738DR_window_heat_fail_ls = window_heat_fail * B738DR_window_heat_l_side_pos * brightness_level
...
-- LOW FUEL PRESSURE ANNUNCIATORS TANK L
	...
	l1_pump_trg = 1
	if B738DR_fuel_tank_pos_lft1 == 1 then
		l1_pump_trg = 0
	end
	...
	if fuel_press_low_left1 == 1 or l1_pump_cur == 1
	...
	l2_pump_trg = 1
	if B738DR_fuel_tank_pos_lft2 == 1 then
		l2_pump_trg = 0
	end
	...
	if fuel_press_low_left2 == 1 or l2_pump_cur == 1
...
-- LOW FUEL PRESSURE ANNUNCIATORS TANK R
	...
	r1_pump_trg = 1
	if B738DR_fuel_tank_pos_rgt1 == 1 then
		r1_pump_trg = 0
	end
	...
	if fuel_press_low_right1 == 1 or r1_pump_cur == 1
	...
	r2_pump_trg = 1
	if B738DR_fuel_tank_pos_rgt2 == 1 then
		r2_pump_trg = 0
	end
	...
	if fuel_press_low_right2 == 1 or r2_pump_cur == 1
...
--ENG VALVE ANNUNS
	...
	local eng_valve_1_status = 0.5
		if simDR_mixture1 > 0 then
		eng_valve_1_status = 1
		end
		if simDR_mixture1 == 1 then
	...
	local eng_valve_2_status = 0.5
		if simDR_mixture2 > 0 then
		eng_valve_2_status = 1
		end
		if simDR_mixture2 == 1 then
