...
function B738_window_temp()
	...
	local temp_true_tgt = B738_rescale(-50, 20, -10, 45, temp_true)
	...
	-- l_side_temp = B738_set_animation_position(l_side_temp, l_side_temp_tgt, -30, 70, 0.04)
	-- l_fwd_temp = B738_set_animation_position(l_fwd_temp, l_fwd_temp_tgt, -30, 70, 0.04)
	-- r_side_temp = B738_set_animation_position(r_side_temp, r_side_temp_tgt, -30, 70, 0.04)
	-- r_fwd_temp = B738_set_animation_position(r_fwd_temp, r_fwd_temp_tgt, -30, 70, 0.04)
