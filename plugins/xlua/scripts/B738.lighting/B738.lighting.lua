...
function B738_light_state()
	...
	-- if simDR_sun_pitch < -3.0 then
		-- if simDR_cockpit_forw_panel == 0 then
			-- simDR_cockpit_forw_panel = 0.4
		-- end
		-- if simDR_cockpit_glareshield == 0 then
			-- simDR_cockpit_glareshield = 0.4
		-- end
	-- end
...
--		end
	...
	simDR_bus_load0 = bus_load0
	simDR_bus_load1 = bus_load1
